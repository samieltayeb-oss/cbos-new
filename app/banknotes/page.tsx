    ...
    <div className="bg-sand-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
          ...
          <div className="lg:col-span-8 bg-white border border-sand-300 rounded-2xl p-6 sm:p-8 shadow-sm flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between pb-4 border-b border-sand-200 mb-6">
                <div>
                  <h2 className="font-serif font-bold text-2xl text-cbos-green-950">
                ...
                <span className="font-mono text-xs px-3 py-1 rounded bg-sand-100 text-ink-muted font-bold">
                  ...
                  return (
                    <button
                      ...
                      className={`absolute -translate-x-1/2 -translate-y-1/2 z-20 w-8 h-8 rounded-full flex items-center justify-center transition-all ${
                        isSelected
                          ? 'bg-cbos-gold text-ink-base scale-125 ring-4 ring-white shadow-lg'
                          : 'bg-cbos-green-900/90 text-white hover:bg-cbos-gold hover:text-ink-base ring-2 ring-white/80'
                      }`}
                      title={t(feat.name)}
                    >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 pt-6 border-t border-sand-200 text-xs">
              <div>
                <span className="font-mono text-ink-muted uppercase block mb-1">
          ...
          <div className="lg:col-span-4 bg-cbos-green-950 text-white rounded-2xl p-6 sm:p-8 border border-cbos-gold/40 flex flex-col justify-between shadow-lg">
            <div>
              ...
              {activeFeature ? (
                <div className="space-y-4">
                  <span className="inline-block px-2.5 py-1 rounded text-xs font-mono font-bold bg-cbos-gold text-ink-base">
