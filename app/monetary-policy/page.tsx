              ...
              >
                <div>
                  ...
                  <div className="bg-sand-50 border border-sand-200 rounded-lg p-3 my-3">
                    ...
                    <div className="text-lg font-serif font-bold text-cbos-green-950 mt-0.5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
          ...
          <div className="lg:col-span-6 bg-white border border-sand-300 rounded-xl p-6 sm:p-8 shadow-sm">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-xs font-mono font-bold text-ink-base uppercase mb-1">
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                {[1000000, 10000000, 50000000, 100000000].map((val) => (
                  <button
                    ...
                    className="text-xs font-mono px-2.5 py-1 rounded bg-sand-100 hover:bg-sand-200 text-ink-base transition-colors"
                  >
              ...
              <div className="bg-cbos-green-950 text-white rounded-xl p-5 space-y-4 mt-6">
          ...
          <div className="lg:col-span-6 bg-white border border-sand-300 rounded-xl p-6 sm:p-8 shadow-sm flex flex-col justify-between">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="p-4 rounded-lg bg-sand-50 border border-sand-200">
                    <div className="font-serif font-bold text-sm text-cbos-green-950 mb-1 flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-cbos-gold shrink-0" />
                      <span>{t(goal.title)}</span>
                    </div>
                    <p className="text-xs text-ink-muted leading-relaxed ps-6">
                      {t(goal.desc)}
                    </p>
                  </div>
                ))}
            ...
            <div className="mt-6 pt-4 border-t border-sand-200 flex items-center justify-between">
              <span className="text-xs font-mono text-ink-muted">CBOS MONETARY BULLETIN 2026</span>
              <Link 
                href="/documents" 
