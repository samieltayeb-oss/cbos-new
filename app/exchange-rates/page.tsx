      ...
      <section className="bg-cbos-green-950 text-white relative overflow-hidden py-16 lg:py-20 border-b border-cbos-gold/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <div className="bg-cbos-green-900/90 border border-cbos-gold/30 rounded-xl p-4 text-xs font-mono shrink-0 space-y-1.5">
              <div className="flex items-center gap-2 text-sand-300">
                <Calendar className="w-3.5 h-3.5 text-cbos-gold" />
                <span>{t({ ar: 'تاريخ النشرة:', en: 'Bulletin Date:' })}</span>
                <span className="text-white font-bold">{officialRatesData.date}</span>
              </div>
              <div className="flex items-center gap-2 text-sand-300">
                <Clock className="w-3.5 h-3.5 text-cbos-gold" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="lg:col-span-7 bg-white border border-sand-300 rounded-xl p-6 sm:p-8 shadow-sm">
            <div className="flex items-center justify-between pb-4 border-b border-sand-200 mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-serif font-bold text-lg text-ink-base">
              ...
              <button
                ...
                className="p-2 rounded-lg bg-sand-100 hover:bg-sand-200 text-ink-base transition-colors"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-sand-50 border border-sand-300 rounded-lg px-4 py-2.5 text-base font-mono font-bold text-ink-base focus:outline-none focus:border-cbos-green-800"
                  />
                  <span className="absolute end-3 top-2.5 text-xs font-mono font-bold text-ink-muted">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-sand-50 border border-sand-300 rounded-lg px-4 py-2.5 text-base font-serif font-bold text-ink-base focus:outline-none focus:border-cbos-green-800"
                >
            ...
            {/* Result Display Box */}
            <div className="bg-cbos-green-950 text-white rounded-xl p-5 border border-cbos-gold/30 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
            ...
            <div>
              <div className="flex items-center justify-between pb-3 border-b border-sand-200 mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-serif font-bold text-base text-ink-base">
        ...
        <div className="bg-white border border-sand-300 rounded-xl shadow-sm overflow-hidden mb-12">
          ...
          <div className="p-6 border-b border-sand-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h2 className="font-serif font-bold text-xl text-ink-base">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="ps-9 pe-4 py-2 text-xs bg-sand-50 border border-sand-300 rounded-lg focus:outline-none focus:border-cbos-green-800 w-44 sm:w-56"
                />
              </div>
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-sand-100 text-ink-base hover:bg-sand-200 text-xs font-mono font-medium transition-colors"
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-start border-collapse">
              <thead>
                <tr className="bg-sand-100/70 border-b border-sand-200 text-xs font-mono uppercase text-ink-muted">
                  ...
                  <th className="py-3.5 px-4 text-end font-bold text-ink-muted hidden md:table-cell">{t({ ar: 'متوسط البنوك', en: 'Bank Avg' })}</th>
                  <th className="py-3.5 px-4 text-end font-bold text-ink-muted hidden lg:table-cell">{t({ ar: 'متوسط الصرافات', en: 'Bureau Avg' })}</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-sand-200 text-sm">
                {filteredRates.map((rate) => (
                  <tr key={rate.currency_code} className="hover:bg-sand-50/80 transition-colors">
                    ...
                    <td className="py-3.5 px-4 font-serif font-medium text-ink-base">
                      {t(rate.currency_name)}
                    </td>
                    <td className="py-3.5 px-4 font-mono text-end font-medium text-ink-base">
                    ...
                    <td className="py-3.5 px-4 font-mono text-end text-ink-muted hidden md:table-cell">
                      {rate.commercial_bank_avg ? rate.commercial_bank_avg.toLocaleString('en-US', { minimumFractionDigits: 2 }) : '—'}
                    </td>
                    <td className="py-3.5 px-4 font-mono text-end text-ink-muted hidden lg:table-cell">
          ...
          {/* Table Footer */}
          <div className="p-4 bg-sand-50 border-t border-sand-200 flex flex-col sm:flex-row items-center justify-between text-xs text-ink-muted gap-2">
        ...
        <div className="bg-white border border-sand-300 rounded-xl p-8 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs text-ink-muted leading-relaxed">
            <div className="p-4 rounded-lg bg-sand-50 border border-sand-200 space-y-2">
              <h3 className="font-serif font-bold text-sm text-ink-base">{t({ ar: 'تسوية حصائل الصادر', en: 'Export Proceeds Repatriation' })}</h3>
            ...
            <div className="p-4 rounded-lg bg-sand-50 border border-sand-200 space-y-2">
              <h3 className="font-serif font-bold text-sm text-ink-base">{t({ ar: 'مخصصات السفر والعلاج', en: 'Travel & Medical Allowances' })}</h3>
            ...
            <div className="p-4 rounded-lg bg-sand-50 border border-sand-200 space-y-2">
              <h3 className="font-serif font-bold text-sm text-ink-base">{t({ ar: 'حظر المضاربات الموازية', en: 'Prohibition of Unlicensed Trading' })}</h3>
