  ...
  return (
    <div className="bg-[#071321] text-white overflow-hidden border-b border-[#22446D]">
      ...
      <section className="relative pt-10 pb-14 sm:pt-14 sm:pb-16 lg:py-20">
        ...
        {/* Soft Ambient Depth (Clean, smooth gradients with ZERO busy patterns) */}
        <div className="absolute top-1/3 left-1/4 -translate-y-1/2 w-[600px] h-[600px] bg-[#2F88C2]/08 rounded-full blur-[140px] pointer-events-none" />
        <div className="absolute bottom-10 right-1/4 w-[500px] h-[500px] bg-[#C58F2B]/05 rounded-full blur-[120px] pointer-events-none" />
